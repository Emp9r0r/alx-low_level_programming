...
/**
 * binary_to_uint - The function that converts binary number to an unsigned int.
 * @b: pointer to string of a 0 and 1 chars.
 *
 * b is NULL.
 *
...
/**
 * _strlen - The function that takes back the length of string.
